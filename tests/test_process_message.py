...
async def test_process_conversa(
    ...
    # Mock presence and messaging
    mock_evolution_client.send_presence = AsyncMock()
    mock_evolution_client.send_text_message = AsyncMock()
...
async def test_process_listar_objetivos(
    ...
    with patch("src.use_cases.process_message.GetGoals") as MockGetGoals:
        ...
        # Verify
        assert mock_evolution_client.send_presence.called
        assert mock_evolution_client.send_text_message.called
        assert mock_evolution_client.send_buttons.called
