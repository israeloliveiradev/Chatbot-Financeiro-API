...
async def test_evolution_webhook_queued():
    payload = {
        ...
        "instance": settings.evolution_instance, # Deve bater com o settings
        "data": {
    ...
    with patch("src.api.routers.webhook.background_process_message", new_callable=AsyncMock) as mock_bg:
        async with AsyncClient(app=app, base_url="http://test") as ac:
            # Precisamos mockar o settings.evolution_instance tbm se necessário
            # Mas vamos assumir o default configurado
